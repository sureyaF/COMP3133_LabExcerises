 ...
 */
var BooleanScalar = function (_Base) {
  _inherits(BooleanScalar, _Base);

  function BooleanScalar() {
    _classCallCheck(this, BooleanScalar);

    return _possibleConstructorReturn(this, (BooleanScalar.__proto__ || Object.getPrototypeOf(BooleanScalar)).apply(this, arguments));
  }

  _createClass(BooleanScalar, [{
    key: 'truthy',
    ...
    value: function truthy() {
      ...
      var values = (0, _utils.flatten)(params);
      var obj = this.clone();
    ...
    value: function create() {
      var coerce = (0, _utils.compose)([].concat(_toConsumableArray(this._func), [Boolean]));
      this.serialize = coerce;
      this.parseValue = coerce;
      this.parseLiteral = function (ast) {
        return ast.kind === _graphql.Kind.BOOLEAN ? ast.value : null;
      };
      return _get(BooleanScalar.prototype.__proto__ || Object.getPrototypeOf(BooleanScalar.prototype), 'create', this).call(this);
    }
  }]);
